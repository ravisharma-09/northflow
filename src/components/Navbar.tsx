      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed top-20 left-4 right-4 z-40 md:hidden bg-glass-bg border border-glass-border shadow-premium rounded-[32px] p-6 backdrop-blur-lg flex flex-col gap-4"
          >
